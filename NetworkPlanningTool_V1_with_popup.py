...
class PCIGUIApp:
    ...
    def create_pci_planning_tab(self):
        ...
        # 地图框架
        self.pci_map_frame = ttk.LabelFrame(pci_frame, text="在线地图")
        self.pci_map_frame.pack(fill=tk.BOTH, expand=True, padx=10, pady=5)
        self.pci_map_widget = TiandituMapPanel(self.pci_map_frame, app_instance=self)
        self.pci_map_widget.pack(fill=tk.BOTH, expand=True)
